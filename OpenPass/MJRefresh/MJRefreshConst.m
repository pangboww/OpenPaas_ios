...
NSString *const MJRefreshFooterPullToRefresh = @"Pull up to load more";
NSString *const MJRefreshFooterReleaseToRefresh = @"Pull up to load more";
NSString *const MJRefreshFooterRefreshing = @"loading...";

NSString *const MJRefreshHeaderPullToRefresh = @"Pull down to refresh";
NSString *const MJRefreshHeaderReleaseToRefresh = @"Pull down to refresh";
