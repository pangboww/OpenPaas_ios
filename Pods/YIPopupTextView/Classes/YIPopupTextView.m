...
#define TEXT_SIZE           (IS_IPAD ? 48 : 24)
#define COUNT_SIZE          (IS_IPAD ? 32 : 16)
#define COUNT_MARGIN        (IS_IPAD ? 20 : 10)
#define CLOSE_IMAGE_WIDTH   (IS_IPAD ? 100 : 50)
#define CLOSE_BUTTON_WIDTH  (IS_IPAD ? 140 : 70)
           ...
           textViewInsets:(UIEdgeInsets)textViewInsets
{
    ...
    if (self) {
        ...
        if (buttonStyle == YIPopupTextViewButtonStyleRightCancel ||
            ...
            _closeButton.frame = CGRectMake(buttonX, _textViewInsets.top-buttonRisingRatio*CLOSE_IMAGE_WIDTH -20, CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH);
        ...
        if (buttonStyle == YIPopupTextViewButtonStyleRightDone ||
            ...
            _acceptButton.frame = CGRectMake(buttonX, _textViewInsets.top-buttonRisingRatio*CLOSE_IMAGE_WIDTH - 15, CLOSE_IMAGE_WIDTH, CLOSE_IMAGE_WIDTH);
